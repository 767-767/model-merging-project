...
if __name__ == "__main__":
    ...
    parser.add_argument("--weight_mask_rate", type=float, default=0., help="weight mask rate")
    ...
    for dataset_name in dataset_names:
        ...
        load_model_path = f"./save_models_provided/{dataset_name}/{args.language_model_name}_lr{learning_rate}"
